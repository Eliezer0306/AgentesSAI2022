    ...
    case 3:      
      ...
      if (reply != null) {
         if (reply.getPerformative() == ACLMessage.INFORM) {
            ...
            JOptionPane.showMessageDialog(a, "El libro "+bookTitle+" Fue comprado a un precio de: "+bestPrice+", al vendedor: "+myAgent.getName(), "Libro "+bookTitle+" comprado",
